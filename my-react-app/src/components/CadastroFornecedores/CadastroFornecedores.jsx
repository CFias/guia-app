        ...
        try {
            ...
            const nomesExistentesNosFornecedores = fornecedores.flatMap((f) =>
                Array.isArray(f.veiculos)
                    ? f.veiculos.map((v) => (typeof v === "string" ? v : v?.nome || ""))
                    : [],
            );

            const todos = [...nomesDaApi, ...nomesExistentesNosFornecedores]
                .filter(Boolean)
                .reduce((acc, nomeAtual) => {
                    const existe = acc.some(
                        (nomeSalvo) => normalizarTexto(nomeSalvo) === normalizarTexto(nomeAtual),
                    );
                    if (!existe) acc.push(nomeAtual);
                    return acc;
                }, [])
                .sort((a, b) =>
            ...
            const formatados = todos.map((nomeVeiculo) => ({
                id: normalizarTexto(nomeVeiculo),
                nome: nomeVeiculo,
            }));
            ...
            <div className="cadastro-fornecedor-header">
                <div>
                    ...
                    <p className="cadastro-fornecedor-subtitle">
                        Cadastre fornecedores, vincule veículos escalados da API e mantenha a
                        base pronta para envio das prévias operacionais.
                    </p>
                </div>
            </div>
                ...
                <section className="cadastro-fornecedor-grid">
                    <div className="cadastro-fornecedor-card cadastro-fornecedor-card-large">
                        ...
                        {loadingInicial ? (
                            ...
                            <form className="cadastro-fornecedor-form" onSubmit={salvarFornecedor}>
                                ...
                                <div className="cadastro-fornecedor-field">
                                    <label>
                                        Veículos vinculados <DirectionsBusRounded fontSize="small" />
                                    </label>
                                    ...
                                    <div className="cadastro-fornecedor-dropdown">
                                        ...
                                        >
                                            ...
                                            <span className="cadastro-fornecedor-dropdown-arrow">▾</span>
                                        </div>
                                    ...
                                    <div className="cadastro-fornecedor-tags">
                                        {veiculosSelecionados.map((veiculo) => (
                                            ...
                                            >
                                                {veiculo.nome}
                                                <span
                                                    onClick={() => !bloqueado && removerVeiculo(veiculo.id)}
                                                >
                                                    ×
                                                </span>
                                            </div>
                                ...
                                <div className="cadastro-fornecedor-options-grid">
                                    <div className="cadastro-fornecedor-options-row">
                                        ...
                                        >
                                            ...
                                            <span className="cadastro-fornecedor-switch-label">
                                                Exibir como Plotado <TaxiAlertRounded fontSize="small" />
                                            </span>
                                        </button>
                                    </div>
                                    ...
                                    <div className="cadastro-fornecedor-options-row">
                                        ...
                                        >
                                            ...
                                            <span className="cadastro-fornecedor-switch-label">
                                                Fornecedor ativo <PlaylistAddCheckRounded fontSize="small" />
                                            </span>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className="cadastro-fornecedor-actions">
                                    <button
                                        type="submit"
                                        disabled={salvando}
                                        className={`cadastro-fornecedor-btn-primary ${salvando ? "is-saving" : ""
                                            }`}
                                    >
                        ...
                        {loadingInicial ? (
                            ...
                            <div className="cadastro-fornecedor-preview">
                                <div className="cadastro-fornecedor-preview-item">
                                    <span className="cadastro-fornecedor-preview-label">Nome</span>
                        ...
                        {loadingInicial ? (
                            ...
                            <div className="cadastro-fornecedor-lista">
                                {fornecedoresFiltrados.map((fornecedor) => {
                                    ...
                                    return (
                                        <div key={fornecedor.id} className="cadastro-fornecedor-item">
                                            <div className="cadastro-fornecedor-item-top">
                                                ...
                                                <div className="cadastro-fornecedor-item-badges">
                                                    <span
                                                        className={`cadastro-fornecedor-status ${fornecedor.ativo === false ? "inativo" : "ativo"
                                                            }`}
                                                    >
                                            ...
                                            <div className="cadastro-fornecedor-item-actions">
                                                ...
                                                <button
                                                    type="button"
                                                    className={`cadastro-fornecedor-btn-secondary ${fornecedor.ativo === false ? "success" : "warning"
                                                        }`}
