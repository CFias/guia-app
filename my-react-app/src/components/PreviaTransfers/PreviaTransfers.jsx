...
const ordenarGrupos = (a, b) =>
    a.veiculo.localeCompare(b.veiculo, "pt-BR", {
        sensitivity: "base",
    });
            ...
            <div className="previa-operacional-grid">
                <div className="previa-operacional-card previa-operacional-card-large">
                    <div className="previa-operacional-card-header">
                        ...
                        <p>Defina a data operacional, ajuste a quantidade de colunas e atualize a prévia.</p>
                    </div>
                ...
                <div className="previa-operacional-card previa-operacional-card-full">
                    <div className="previa-operacional-card-header">
                        ...
                        <p>
                            Quantidade total de veículos, serviços consolidados, pax e divisão por tipo operacional.
                        </p>
                    </div>
                ...
                <div className="previa-operacional-card previa-operacional-card-full">
                    <div className="previa-operacional-card-header">
                        ...
                        <p>
                            Consolidada por escala, agrupada por veículo e exibida em formato de planilha operacional.
                        </p>
                    </div>
                        ...
                        <div className="previa-operacional-sheet-wrap">
                            ...
                            <div className="previa-operacional-sheet-body">
                                {grade.map((linha, linhaIndex) => (
                                    ...
                                    >
                                        {linha.map((grupo) => (
                                            <div key={grupo.chave} className="previa-operacional-coluna">
